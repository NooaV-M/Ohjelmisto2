...
const sectElem = document.querySelector("#pictures")

for (let i of picArray) {
  let articElem = document.createElement('article');
  articElem.className = 'card';
  sectElem.appendChild(articElem);

  let headerElem = document.createElement('h2');
  headerElem.textContent = i.title
  articElem.appendChild(headerElem);

  let figureElem = document.createElement('figure');

  let imgElem = document.createElement('img');
  imgElem.src = i.image.medium
  imgElem.alt = i.title
  figureElem.appendChild(imgElem);

  let figcaptionElem = document.createElement('figcaption');
  figcaptionElem.textContent = i.caption
  figureElem.appendChild(figcaptionElem);

  let paragraphElem = document.createElement('p');
  paragraphElem.textContent = i.description
}